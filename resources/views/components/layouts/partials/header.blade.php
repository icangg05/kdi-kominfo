		...
		<div class="sm:order-3 flex items-center gap-x-2">
			...
			<div class="hidden lg:block relative">
				<input type="text"
					...
					class="py-2.5 sm:py-3 px-4 ps-11 block w-full border-gray-300 rounded-lg sm:text-sm focus:z-10 focus:border-primary focus:ring-0 disabled:opacity-50 disabled:pointer-events-none">
		...
		<div id="hs-navbar-alignment"
			...
			<div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
				...
				<div
					...
					<button id="hs-navbar-example-dropdown"
						type="button"
						class="hs-dropdown-toggle flex items-center w-full text-gray-800 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 font-medium"
						aria-haspopup="menu" aria-expanded="false" aria-label="Mega Menu">
						Layanan
						<svg class="hs-dropdown-open:-rotate-180 sm:hs-dropdown-open:rotate-0 duration-300 ms-1 shrink-0 size-4"
							xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
