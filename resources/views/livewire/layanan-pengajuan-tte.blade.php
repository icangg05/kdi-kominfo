			...
			<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
				...
				<div class="left lg:text-right space-y-2">
					<p class="text-sm text-gray-800">
						...
						<a class="text-blue-600 hover:underline" href="mailto:{{ $global_email }}">{{ $global_email }}</a>
					</p>
					<p class="text-sm text-gray-800"><i class="fas fa-phone-alt text-primary mr-1"></i> {{ $global_telp }}</p>
